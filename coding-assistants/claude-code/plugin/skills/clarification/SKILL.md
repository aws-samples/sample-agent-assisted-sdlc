...
WHEN HALTING:
  ...
  2. Post a single comment via mcp__gateway__project-management___add_issue_comment
     listing all questions clearly.
  3. Set labels: ["{{LABEL_PREFIX}}:need-clarification"] via mcp__gateway__project-management___issue_write.

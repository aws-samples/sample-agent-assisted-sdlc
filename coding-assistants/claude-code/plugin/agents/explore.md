...
tools: Read, Grep, Glob, Bash, Write, mcp__gateway__project-management___issue_write, mcp__gateway__project-management___add_issue_comment, mcp__gateway__project-management___issue_read, mcp__gateway__source-control___pull_request_read
model: sonnet
skills:
  - formatting
---
...
2. Set labels: ["{{LABEL_PREFIX}}:explore"] via mcp__gateway__project-management___issue_write.
...
If ./.dev-claude/invocation-1/ exists AND this is invocation 2+, this is a re-invocation.
  ...
  - Read new issue comments via mcp__gateway__project-management___issue_read
  - Read PR review comments via mcp__gateway__source-control___pull_request_read
